...
gulp.task('copy:node_modules', function () {
    return gulp.src(conf.paths.node_modules, {
            base: './node_modules/'
        })
...
gulp.task('copy:bower_components', function () {
    return gulp.src(conf.paths.bower_components, {
...
gulp.task('dependencies', gulpSequence('copy:node_modules', 'copy:bower_components'));

gulp.task('build', gulpSequence('index', 'compile', 'static', 'copy:assets'));
...
gulp.task('deploy', gulpSequence('build', 'dependencies', 'rsync'));

gulp.task('deployts', gulpSequence('build', 'rsync'));
